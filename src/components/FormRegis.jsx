...
const FormRegis = ({ user, userLogin, login, setLogin, handleRegister, inputRegister, handleLogin, inputLogin }) => {
  const spanStyle = {
    color: "blue",
    cursor: "pointer",
    marginLeft: "5px",
  ...
  return (
    ...
    (
      <>
        <Row>
          {login ? <h1 className="text-center">REGISTER</h1> : <h1 className="text-center">LOGIN</h1>}
          {login ? (
            // Register
